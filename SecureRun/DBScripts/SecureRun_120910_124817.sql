...
-- User_Profile [rel1]
alter table "public"."profile"  add column  "user_oid"  int4;
alter table "public"."profile"   add constraint fk_profile_user foreign key ("user_oid") references "public"."user" ("oid");
